...
start = datetime.datetime(2019, 4, 25, 12, 00)
end = datetime.datetime(2019, 5, 3, 12, 00)
for r in arrow.Arrow.range('day', start, end):  # 获取间隔单位时间的时间
    print(r)
    

    str_date_scrapy = r.format('YYYYMMDD')
    str_date = r.format('YYYY-MM-DD')
    params = {
